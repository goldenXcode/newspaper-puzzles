...
package ws.crandell.newspaperpuzzles.wordsearch.view.controller;
...
import ws.crandell.newspaperpuzzles.wordsearch.model.Grid;
import ws.crandell.newspaperpuzzles.wordsearch.model.HighScore;
import ws.crandell.newspaperpuzzles.wordsearch.model.Preferences;
import ws.crandell.newspaperpuzzles.wordsearch.model.Theme;
import ws.crandell.newspaperpuzzles.wordsearch.model.dictionary.DictionaryFactory;
...
//			Debug.stopMethodTracing();
		...
		protected void onPreExecute() {
			...
			if (getCurrentHighScore() == null || conman.getActiveNetworkInfo() == null || !conman.getActiveNetworkInfo().isConnected()) {
				...
				pd.setMessage(wordSearch.getString(R.string.ws_HIGH_SCORE_CALCULATING));
	...
	public void newWordSearch() {
		String category = PreferenceManager.getDefaultSharedPreferences(wordSearch).getString(wordSearch.getString(R.string.ws_prefs_category), wordSearch.getString(R.string.ws_RANDOM));
...
//		wordSearch.trackGame();
	...
	public void updateTheme() {
		String themeStr = PreferenceManager.getDefaultSharedPreferences(wordSearch).getString(wordSearch.getString(R.string.ws_PREFS_THEME), Theme.ORIGINAL.toString());
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		if (wordSearch.getString(R.string.ws_PREFS_THEME).equals(key)) {
			updateTheme();
		} else if (wordSearch.getString(R.string.ws_prefs_touch_mode).equals(key)) {
			updateTouchMode();
		}
	}
}
