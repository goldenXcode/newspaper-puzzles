...
public class Preferences {
	...
	public Preferences(Context ctx) {
		...
		PREFS_CATEGORY = ctx.getString(R.string.ws_prefs_category);
		PREFS_SIZE = ctx.getString(R.string.ws_prefs_size);
		PREFS_TOUCHMODE = ctx.getString(R.string.ws_prefs_touch_mode);
		PREFS_TOUCHMODE_DEFAULT = ctx.getString(R.string.ws_DRAG);
		PREFS_TOUCHMODE_DRAG = ctx.getString(R.string.ws_DRAG);
	}
