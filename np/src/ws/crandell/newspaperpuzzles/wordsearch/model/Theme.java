package ws.crandell.newspaperpuzzles.wordsearch.model;
...
public enum Theme {
	...
	NIGHTSKY(R.drawable.ws_background1, Color.parseColor("white"), Color.parseColor("green"), Color.parseColor("yellow"), Color.parseColor("red"), Color.parseColor("blue")),
	...
	PINK(R.drawable.ws_background3, Color.parseColor("black"), Color.parseColor("#05a9a7"), Color.parseColor("#00d0ce"), Color.parseColor("#0000ff"), Color.parseColor("#00ff00")),
	SEAGREEN(R.drawable.ws_background4, Color.parseColor("yellow"), Color.parseColor("#ffba00"), Color.parseColor("red"), Color.parseColor("#ff00fc"), Color.parseColor("#ffc000"));
