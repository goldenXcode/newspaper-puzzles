...
import ws.crandell.newspaperpuzzles.crossword.versions.DefaultUtil;
...
public abstract class AbstractDownloader implements Downloader {
    protected static final Logger LOG = Logger.getLogger("ws.crandell.newspaperpuzzles.crossword");
    public static File DOWNLOAD_DIR = NPPCrosswordsApplication.CROSSWORDS;
