...
import ws.crandell.newspaperpuzzles.crossword.BrowseActivity.Provider;
...
import ws.crandell.newspaperpuzzles.crossword.net.DummyDownloader;
...
public class DownloadPickerDialogBuilder {
    ...
    public DownloadPickerDialogBuilder(Activity a, final OnDownloadSelectedListener downloadButtonListener, int year,
        ...
        View layout = inflater.inflate(R.layout.cw_download_dialog, (ViewGroup) mActivity.findViewById(R.id.download_root));
