...
import ws.crandell.newspaperpuzzles.sudoku.game.SudokuGame.OnPuzzleSolvedListener;
import ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod.IMControlPanel;
import ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod.IMControlPanelStatePersister;
import ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod.IMNumpad;
import ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod.IMPopup;
import ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod.IMSingleNumber;
...
public class SudokuPlayActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.s_sudoku_play);
		...
		mHintsQueue.showOneTimeHint("welcome", R.string.s_welcome, R.string.s_first_run_hint);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, MENU_ITEM_UNDO, 0, R.string.s_undo)
				.setShortcut('1', 'u')
				.setIcon(android.R.drawable.ic_menu_revert);

		menu.add(0, MENU_ITEM_RESTART, 1, R.string.s_restart)
				.setShortcut('7', 'r')
				.setIcon(android.R.drawable.ic_menu_rotate);

		menu.add(0, MENU_ITEM_CLEAR_ALL_NOTES, 0, R.string.s_clear_all_notes)
				.setShortcut('3', 'a')
				.setIcon(android.R.drawable.ic_menu_delete);

		if (mFillInNotesEnabled) {
			menu.add(0, MENU_ITEM_FILL_IN_NOTES, 0, R.string.s_fill_in_notes)
					.setIcon(android.R.drawable.ic_menu_edit);
		}

		menu.add(0, MENU_ITEM_HELP, 1, R.string.s_help)
				.setShortcut('0', 'h')
				.setIcon(android.R.drawable.ic_menu_help);

		menu.add(0, MENU_ITEM_SETTINGS, 1, R.string.s_settings)
				.setShortcut('9', 's')
				.setIcon(android.R.drawable.ic_menu_preferences);

		menu.add(0, MENU_ITEM_SET_CHECKPOINT, 2, R.string.s_set_checkpoint);
		menu.add(0, MENU_ITEM_UNDO_TO_CHECKPOINT, 2, R.string.s_undo_to_checkpoint);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			...
			case MENU_ITEM_SETTINGS:
				...
				return true;
			case MENU_ITEM_HELP:
				mHintsQueue.showHint(R.string.s_help, R.string.s_help_text);
				return true;
		...
		switch (id) {
			case DIALOG_WELL_DONE:
				return new AlertDialog.Builder(this)
						...
						.setTitle(R.string.s_well_done)
						.setMessage(getString(R.string.s_congrats, mGameTimeFormatter.format(mSudokuGame.getTime())))
			...
			case DIALOG_RESTART:
				return new AlertDialog.Builder(this)
						...
						.setMessage(R.string.s_restart_confirm)
			...
			case DIALOG_CLEAR_NOTES:
				return new AlertDialog.Builder(this)
						.setIcon(android.R.drawable.ic_menu_delete)
						.setTitle(R.string.s_app_name)
						.setMessage(R.string.s_clear_all_notes_confirm)
						.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int whichButton) {
			...
			case DIALOG_UNDO_TO_CHECKPOINT:
				return new AlertDialog.Builder(this)
						.setIcon(android.R.drawable.ic_menu_delete)
						.setTitle(R.string.s_app_name)
						.setMessage(R.string.s_undo_to_checkpoint_confirm)
						.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int whichButton) {
