...
import ws.crandell.newspaperpuzzles.sudoku.game.Cell;
import ws.crandell.newspaperpuzzles.sudoku.game.CellCollection;
import ws.crandell.newspaperpuzzles.sudoku.game.CellNote;
import ws.crandell.newspaperpuzzles.sudoku.game.SudokuGame;
import ws.crandell.newspaperpuzzles.sudoku.game.CellCollection.OnChangeListener;
...
public class SudokuBoardView extends View {
	...
	public SudokuBoardView(Context context, AttributeSet attrs/*, int defStyle*/) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.s_SudokuBoardView/*, defStyle, 0*/);

		setLineColor(a.getColor(R.styleable.s_SudokuBoardView_s_lineColor, Color.BLACK));
		setSectorLineColor(a.getColor(R.styleable.s_SudokuBoardView_s_sectorLineColor, Color.BLACK));
		setTextColor(a.getColor(R.styleable.s_SudokuBoardView_s_textColor, Color.BLACK));
		setTextColorReadOnly(a.getColor(R.styleable.s_SudokuBoardView_s_textColorReadOnly, Color.BLACK));
		setTextColorNote(a.getColor(R.styleable.s_SudokuBoardView_s_textColorNote, Color.BLACK));
		setBackgroundColor(a.getColor(R.styleable.s_SudokuBoardView_s_backgroundColor, Color.WHITE));
		setBackgroundColorSecondary(a.getColor(R.styleable.s_SudokuBoardView_s_backgroundColorSecondary, NO_COLOR));
		setBackgroundColorReadOnly(a.getColor(R.styleable.s_SudokuBoardView_s_backgroundColorReadOnly, NO_COLOR));
		setBackgroundColorTouched(a.getColor(R.styleable.s_SudokuBoardView_s_backgroundColorTouched, Color.rgb(50, 50, 255)));
		setBackgroundColorSelected(a.getColor(R.styleable.s_SudokuBoardView_s_backgroundColorSelected, Color.YELLOW));
