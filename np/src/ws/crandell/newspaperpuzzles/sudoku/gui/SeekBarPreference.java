...
public class SeekBarPreference extends DialogPreference {
	...
	public SeekBarPreference(Context context, AttributeSet attrs) {
		...
		setDialogLayoutResource(R.layout.s_preference_dialog_seek_bar);

		mSeekBar = new SeekBar(context, attrs);
		// Give it an ID so it can be saved/restored
		mSeekBar.setId(R.id.s_seek_bar);
		mSeekBar.setOnSeekBarChangeListener(mOnSeekBarChangeListener);

		TypedArray a =
				context.obtainStyledAttributes(attrs, R.styleable.s_SeekBarPreference);
		setMin(a.getInt(R.styleable.s_SeekBarPreference_s_min, mMin));
		setMax(a.getInt(R.styleable.s_SeekBarPreference_s_max, mMax));
		setValue(a.getInt(R.styleable.s_SeekBarPreference_s_value, mValue));
		setValueFormat(a.getString(R.styleable.s_SeekBarPreference_s_valueFormat));
