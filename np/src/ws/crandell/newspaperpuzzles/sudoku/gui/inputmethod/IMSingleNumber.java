...
package ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod;
...
import ws.crandell.newspaperpuzzles.sudoku.gui.HintsQueue;
import ws.crandell.newspaperpuzzles.sudoku.gui.SudokuBoardView;
import ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod.IMControlPanelStatePersister.StateBundle;
...
public class IMSingleNumber extends InputMethod {
	...
	public int getNameResID() {
		return R.string.s_single_number;
	}

	@Override
	public int getHelpResID() {
		return R.string.s_im_single_number_hint;
	}

	@Override
	public String getAbbrName() {
		return mContext.getString(R.string.s_single_number_abbr);
	}

	@Override
	protected View createControlPanelView() {
		LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View controlPanel = inflater.inflate(R.layout.s_im_single_number, null);
	...
	private void update() {
		switch (mEditMode) {
			case MODE_EDIT_NOTE:
				mSwitchNumNoteButton.setImageResource(R.drawable.s_pencil);
				break;
			case MODE_EDIT_VALUE:
				mSwitchNumNoteButton.setImageResource(R.drawable.s_pencil_disabled);
				break;
		}
		...
		mGuiHandler.postDelayed(new Runnable() {
			...
			public void run() {
				for (Button b : mNumberButtons.values()) {
					b.setBackgroundResource(R.drawable.s_btn_default_bg);
					if (b.getTag().equals(mSelectedNumber)) {
						...
						LightingColorFilter selBkgColorFilter = new LightingColorFilter(
								mContext.getResources().getColor(R.color.s_im_number_button_selected_background), 0);
				...
				if (mHighlightCompletedValues) {
					int completedTextColor = mContext.getResources().getColor(R.color.s_im_number_button_completed_text);
					for (Map.Entry<Integer, Integer> entry : valuesUseCount.entrySet()) {
						...
						if (highlightValue) {
							...
							if (b.getTag().equals(mSelectedNumber)) {
								...
								b.setBackgroundResource(R.drawable.s_btn_completed_bg);
							}
						}
					}
				}
