...
public class IMNumpad extends InputMethod {
	...
	protected View createControlPanelView() {
		...
		View controlPanel = inflater.inflate(R.layout.s_im_numpad, null);
	...
	public int getNameResID() {
		return R.string.s_numpad;
	}

	@Override
	public int getHelpResID() {
		return R.string.s_im_numpad_hint;
	}

	@Override
	public String getAbbrName() {
		return mContext.getString(R.string.s_numpad_abbr);
	}
