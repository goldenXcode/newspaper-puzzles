...
import ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod.IMPopupDialog.OnNoteEditListener;
import ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod.IMPopupDialog.OnNumberEditListener;
...
public class IMPopup extends InputMethod {
	...
	public int getNameResID() {
		return R.string.s_popup;
	}

	@Override
	public int getHelpResID() {
		return R.string.s_im_popup_hint;
	}

	@Override
	public String getAbbrName() {
		return mContext.getString(R.string.s_popup_abbr);
	}

	@Override
	protected View createControlPanelView() {
		LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		return inflater.inflate(R.layout.s_im_popup, null);
	}
