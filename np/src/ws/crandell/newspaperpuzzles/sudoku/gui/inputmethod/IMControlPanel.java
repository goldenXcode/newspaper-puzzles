...
import ws.crandell.newspaperpuzzles.sudoku.gui.SudokuBoardView.OnCellSelectedListener;
import ws.crandell.newspaperpuzzles.sudoku.gui.SudokuBoardView.OnCellTappedListener;
...
public class IMControlPanel extends LinearLayout {
	...
	public void activateNextInputMethod() {
		...
		if (id >= mInputMethods.size()) {
			if (mHintsQueue != null) {
				mHintsQueue.showOneTimeHint("thatIsAll", R.string.s_that_is_all, R.string.s_im_disable_modes_hint);
			}
			id = 0;
		}
