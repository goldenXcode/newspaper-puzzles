...
import ws.crandell.newspaperpuzzles.sudoku.gui.inputmethod.InputMethod;
...
public class SudokuEditActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.s_sudoku_edit);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, MENU_ITEM_SAVE, 0, R.string.s_save)
				.setShortcut('1', 's')
	...
	private void savePuzzle() {
		...
		switch (mState) {
			case STATE_EDIT:
				...
				Toast.makeText(getApplicationContext(), R.string.s_puzzle_updated, Toast.LENGTH_SHORT).show();
				break;
			case STATE_INSERT:
				mGame.setCreated(System.currentTimeMillis());
				mDatabase.insertSudoku(mFolderID, mGame);
				Toast.makeText(getApplicationContext(), R.string.s_puzzle_inserted, Toast.LENGTH_SHORT).show();
				break;
		}
	}
}
