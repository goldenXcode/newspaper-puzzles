...
public class FileListActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.s_file_list);
		...
		File[] files = selected_dir.listFiles(new FileFilter() {
			@Override
			public boolean accept(File pathname) {
				return pathname.isFile() && !pathname.isHidden() && pathname.canRead() && (pathname.getName().endsWith(".sudoku") || pathname.getName().endsWith(".sdm"));
			}
		});
		...
		SimpleAdapter adapter = new SimpleAdapter(this, (List<? extends Map<String, ?>>) mList, R.layout.s_folder_list_item, from, to);
		...
		switch (id) {
			case DIALOG_IMPORT_FILE:
				return new AlertDialog.Builder(this)
						...
						.setTitle(R.string.s_import_file)
						.setPositiveButton(R.string.s_import_file, new DialogInterface.OnClickListener() {
	...
	protected void onPrepareDialog(int id, Dialog dialog) {
		...
		switch (id) {
			case DIALOG_IMPORT_FILE:
				dialog.setTitle(getString(R.string.s_import_file_title, mSelectedFile.getName()));
				break;
		}
	}
