package ws.crandell.newspaperpuzzles.sudoku.utils;
...
public class AndroidUtils {
	...
	public static void setThemeFromPreferences(Context context) {
		...
		if (theme.equals("default")) {
			context.setTheme(R.style.s_Theme_Default);
		} else if (theme.equals("paperi")) {
			context.setTheme(R.style.s_Theme_PaperI);
		} else if (theme.equals("paperii")) {
			context.setTheme(R.style.s_Theme_PaperII);
		} else {
			context.setTheme(R.style.s_Theme_Default);
		}
	}
	...
	/**
	 * Returns version code of Sudoku.
	 *
	 * @return
	 */
	...
	/**
	 * Returns version name of Sudoku.
	 *
	 * @return
	 */
