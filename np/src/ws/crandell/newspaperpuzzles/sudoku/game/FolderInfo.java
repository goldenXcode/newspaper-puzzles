...
public class FolderInfo {
	...
	public String getDetail(Context c) {
		...
		if (puzzleCount == 0) {
			...
			sb.append(c.getString(R.string.s_no_puzzles));
		} else {
			// there are some puzzles
			sb.append(puzzleCount == 1 ? c.getString(R.string.s_one_puzzle) : c.getString(R.string.s_n_puzzles, puzzleCount));
			...
			if (playingCount != 0 || unsolvedCount != 0) {
				...
				if (playingCount != 0) {
					sb.append(c.getString(R.string.s_n_playing, playingCount));
					if (unsolvedCount != 0) {
						sb.append(", ");
					}
				}
				...
				if (unsolvedCount != 0) {
					sb.append(c.getString(R.string.s_n_unsolved, unsolvedCount));
				}
			...
			if (unsolvedCount == 0 && puzzleCount != 0) {
				sb.append(" (").append(c.getString(R.string.s_all_solved)).append(")");
			}
